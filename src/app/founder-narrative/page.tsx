...
const sevenDayPlan = [
  "Rename everything internally to AUTORA OS",
  ...
  return (
    <div className="space-y-10">
      ...
      <section className="rounded-3xl border border-steel/12 bg-white p-7 shadow-soft">
        ...
        <blockquote className="mt-4 max-w-4xl border-l-4 border-tide pl-4 text-pretty text-sm leading-7 text-steel">
          &quot;AUTORA, a subsidiary of CreatePrivateLtd, builds the WhatsApp and lead operating system for automotive dealerships.
          Dealerships lose revenue not because of lack of demand, but because leads are slow, fragmented, and poorly
          handled, especially on WhatsApp. We sit directly in the dealer&apos;s communication flow, responding instantly,
          qualifying leads, booking test drives, and tracking conversion in real time. We started as an agency to earn
          distribution and trust. Today, we are a vertical SaaS platform embedded in dealership operations. Our
          customers do not churn because once we manage their conversations, replacing us means losing revenue. We are
          focused on automotive first. Once we dominate this vertical, expansion becomes optional, not necessary.&quot;
        </blockquote>
      </section>

      <section className="grid gap-4 md:grid-cols-2">
        <article className="rounded-2xl border border-steel/12 bg-white p-6 shadow-sm">
          <h2 className="text-balance text-xl font-semibold text-coal">When buyers ask &quot;Why you?&quot;</h2>
        ...
        <article className="rounded-2xl border border-steel/12 bg-white p-6 shadow-sm">
          <h2 className="text-balance text-xl font-semibold text-coal">When they ask &quot;What is the exit?&quot;</h2>
          <ul className="mt-3 space-y-2 text-sm text-steel">
      ...
      <section className="rounded-3xl border border-ember/20 bg-[#fffaf6] p-6 shadow-sm">
        ...
        <ol className="mt-4 list-decimal space-y-2 pl-6 text-sm text-steel">
