    ...
    <div className="space-y-16">
      <section className="hero-panel p-8 md:p-12">
        ...
        <p className="relative z-10 mt-3 max-w-2xl text-pretty text-sm leading-relaxed text-steel">
          Created specifically for new-vehicle dealerships, with a focus on Chinese automotive brands in South Africa.
        </p>
        ...
        <div className="relative z-10 mt-8 flex flex-wrap gap-3">
          <ButtonLink href="/book">Book Free 15-Minute Audit</ButtonLink>
      ...
      <section className="surface-card p-7">
        ...
        <p className="mt-6 text-sm text-steel">
          <span className="font-semibold text-coal">Optional growth add-on:</span> Paid demand generation available after onboarding (Meta/Google Ads for dealerships ready to scale).
        </p>
        <div className="mt-5">
