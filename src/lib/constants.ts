...
export const PARENT_COMPANY_NAME = "CreatePrivateLtd";
export const PLATFORM_SUBSIDIARY_LINE = `A subsidiary of ${PARENT_COMPANY_NAME}`;
...
export const NAV_LINKS = [
  { href: "/", label: "Home" },
  { href: "/dealer-os", label: "AUTORA OS" },
...
export const ADD_ONS = [
  {
    label: "Optional Growth Add-On (Post-Onboarding)",
    price: "Custom pricing",
    description: "Only activated once lead handling is stable and conversion-ready."
  }
] as const;
...
export const HOW_IT_WORKS = [
  {
    ...
    description: "AUTORA centralizes inbound WhatsApp, web, and ad leads into one inbox."
  },
  {
...
// Backward-compatible alias for snapshots/backups still importing the old constant name.
