  ...
  return (
    <div className="space-y-10">
      <section className="max-w-4xl">
        <p className="text-xs uppercase tracking-[0.15em] text-tide">Dealer OS V1</p>
        <h1 className="mt-2 text-4xl font-semibold text-coal md:text-5xl">Revenue control system for dealerships</h1>
        <p className="mt-4 text-base text-steel">
          Dealer OS is intentionally narrow in V1: WhatsApp, CRM workflow, booking conversion, and operational visibility.
        </p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-2">
        {screens.map((screen) => (
          <article key={screen.title} className="rounded-2xl border border-steel/12 bg-white p-6 shadow-sm">
            <h2 className="text-xl font-semibold text-coal">{screen.title}</h2>
      ...
      <section className="flex flex-wrap gap-3">
        <ButtonLink href="/pricing">View Dealer OS Pricing</ButtonLink>
