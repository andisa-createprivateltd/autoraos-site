  ...
  return (
    <div className="space-y-12">
      <section className="max-w-4xl">
        ...
        <h1 className="mt-2 text-4xl font-semibold text-coal md:text-5xl">
      ...
      <section className="grid gap-5 md:grid-cols-3">
        {PRICING_TIERS.map((tier) => (
          ...
          >
            ...
            <p className="mt-2 text-sm text-steel">{tier.description}</p>
      ...
      <section className="rounded-3xl border border-steel/12 bg-white p-6 shadow-sm">
        <h2 className="text-2xl font-semibold text-coal">Add-on (Mandatory For Most)</h2>
